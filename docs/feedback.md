...
This tool can calculate how much time is left from the birthday to the given time.
...
- [**GitHub Issue**](https://github.com/jaywcjlove/time-passage/issues/new/choose)  
